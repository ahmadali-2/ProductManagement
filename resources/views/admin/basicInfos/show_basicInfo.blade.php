...
<div class="card card-default">
    ...
    <div class="card-body">
        <table class="table">
            ...
            <tbody>
                        <tr>
                            <td><img src="{{asset("$basicInfo->website_logo")}}" width="100px" height="100px" alt="No Image" style="border-radius: 5px;"></td>
...
<div class="card card-default">
    ...
    <form method="POST" action="{{route('updateSocialLinks')}}">
        ...
        <table class="table">
            <tbody>
                    <tr>
                        <td><img src="{{asset('Images/BasicInfo/Whatsapp-icon .png')}}" width="42px" height="42px" style="border-radius: 5px;"></td>
                    ...
                    <tr>
                        <td><img src="{{asset('Images/BasicInfo/facebook-icon.png')}}" width="42px" height="42px" style="border-radius: 5px;"></td>
                    ...
                    <tr>
                        <td><img src="{{asset('Images/BasicInfo/Linkedin-icon.png')}}" width="42px" height="42px" style="border-radius: 5px;"></td>
                    ...
                    <tr>
                        <td><img src="{{asset('Images/BasicInfo/Twitter-icon.png')}}" width="42px" height="42px" style="border-radius: 5px;"></td>
