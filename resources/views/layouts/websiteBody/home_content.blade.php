  ...
  <section id="hero">
    <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        @if($check == true)
          <div class="carousel-item active" style="background-image: url({{$hero->hero_logo}});">
        @else
          <div class="carousel-item" style="background-image: url({{$hero->hero_logo}});">
        @endif
          ...
          @foreach($brands as $brand)
            <div class="col-lg-3 col-md-4 col-6">
              <div class="client-logo">
                <img src="{{asset("$brand->brand_logo")}}" class="img-fluid" alt="">
              </div>
            </div>
          @endforeach
        @endif
